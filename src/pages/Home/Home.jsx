...
const Home = () => {
  ...
  return (
    <>
            ...
            {topClasses.map((topClass, index) => (
              <div key={index}>
                <div
                  ...
                  <img src={topClass.image} alt="" className="h-56 w-full"/>
                  ...
                  {user ? (
                    <button
                      ...
                      disabled={
                        ...
                        topClass.totalSeat <= 0 || isAdmin.role === 'admin'
                      }
      ...
      <div className="pt-12 pb-20 px-6 bg-[#e9f8ff]">
        <Container>
          <SectionTitle
            title="Lingua Stats"
            subTitle="Check out what we have done so far"></SectionTitle>
          <div className="stats shadow w-full">
            <div className="stat place-items-center bg-[#e9f8ff]">
